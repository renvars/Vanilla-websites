const amount_to_pay = document.querySelector("#total_price")
const reminder = document.querySelector('#connect_reminder_wrapper')
const close_reminder = document.querySelector("#reminder_close_x")
close_reminder.onclick = () => {
...
document.querySelector("#plus").onclick = function incrementMint() {
    if (accountouter == undefined) {
        reminder.classList.add("show")

    } else {
        var test = document.querySelector("#mint_amount")
        var mintVal = parseInt(test.innerHTML);
        if (mintVal < 2) {
            mintVal += 1
        }
        test.innerHTML = mintVal
        amount_to_pay.innerHTML = `Total price - Only Gas`
...
const ADDRESS = "0x1068311F701dC0dA5FaE6640a1d8DF5CFEDaf5B3";
...
(async() => {
    ...
    if (typeof window.ethereum !== "undefined") {
        let account;
        document.querySelector("#connect_btn_top").addEventListener(touchEvent,
          async() => {
            ...
            if (window.ethereum) {
                ...
                if (contract) {
                  ...
                  document.querySelector("#mint_top").onclick = () => {
                      ...
                      contract.methods.mint(mint_amnt).send({ from: account, value: String(mint_amnt *0001000000000000000) })
                  }
      ...
      let account;
        ...
        document.querySelector("#mint_top").addEventListener(touchEvent,async() => {
          let mintContract =  await contract(ABI,ADDRESS)
          var mint_amnt = parseInt(document.querySelector("#mint_amount").innerHTML)
          console.log("Minting " + mint_amnt)
          console.log("Account " + account)
          mintContract.methods.mint(mint_amnt).send({from:account,value:String(mint_amnt * 0001000000000000000)})
...
//Adress of contract - 0x6DF68d3E861067Ac7A4C1Ff0718bDC6E62f3d3C0
//Contract Abi -
